...
namespace NzbDrone.Core.Drive
{
    ...
    public class DispatchDiskProvider : IDiskProvider
    {
        ...
        public void MoveFolder(string source, string destination, bool overwrite = false) => _inner.MoveFolder(source, destination, overwrite);
        ...
        public List<FileInfo> GetFileInfos(string path, bool recursive = false) => _inner.GetFileInfos(path, recursive);
